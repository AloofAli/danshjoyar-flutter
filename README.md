...
│   ├── DaneshjoyarApp.dart      # Root widget, defines initial navigation
│   ├── pages/                   # UI pages (login, signup, home, etc.)
│   │   ├── saraPage.dart            # Main home page
│   │   ├── tamrina.dart         # Assignment upload page
│   │   ├── khabaraPage.dart         # News feed page
│   │   ├── classaPage.dart          # Course management page
│   │   └── karapage.dart
│   ├── NewsHandling/            # Logic for fetching and displaying news articles
│   ├── asset/                 # Reusable UI components
│   ├── Main/                  # Data models representing entities (e.g., user, course, assignment)
│   └── ...
```
